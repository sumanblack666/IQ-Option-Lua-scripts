...
shortSignal = iff(((k >= stochUpperValue and d >= stochUpperValue) and (h <= close)), true, false)
longSignal = iff(((k <= stochLowerValue and d <= stochLowerValue) and (l >= close)), true, false)
